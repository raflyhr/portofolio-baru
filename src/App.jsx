    ...
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1" id="beranda">
        <div className="animate__animated animate__fadeInUp animate__delay-3s">
          ...
          <div className="flex item-center sm:gap-4 gap-2">
            ...
            >
              Lihat Prestasi <i class="ri-arrow-down-line ri-lg"></i>
            </a>
          </div>
        </div>
        <img
      ...
      <div className="tentang mt-32 py-10" id="tentang">
        ...
        <div className="tools mt-12">
          ...
          <p className="xl:w-2/5 lg:2/4 md:w-2/3 sm:w-3/4 w-full text-base/loose opacity-50"  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">
          ...
          hover:bg-zinc-800 group"
            ...
            >
              <img
                src={tool.gambar}
                alt="tools image"
                className="w-14 bg-zinc800 p-1 group-hover:bg-zinc-500"
              />
              <div>
...
{/* prestasi */}
      ...
      <form action="https://formsubmit.co/raflyhermansyah565@gmail.com" method="POST" className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md" autoComplete="off"  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
        <div className="flex flex-col gap-6">
          ...
          <div className="text-center">
            <button type="submit" className="bg-blue-700 p-3 rounded-lg w-full cursor-pointer border-zinc-600 hover:bg-blue-600">Kirim Pesan</button>
          </div>
        </div>
      </form>
      </div>
